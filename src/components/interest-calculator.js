        ...
        <form className="interest-calculator"
            ...
            <div className="form-group">
                ...
                <input type="number" id="principal" value={props.principal}
                    min="0" onChange={(e) => props.dispatch(actions.setPrincipal(e.target.value))} />
            </div>
            <div className="form-group">
                <label htmlFor="interest">Interest rate (%)</label>
                <input type="number" id="interest" value={props.interest}
                    min="0" max="100" step="0.1"
                    onChange={(e) => props.dispatch(actions.setInterest(e.target.value))} />
            </div>
            <div className="form-group">
                <label htmlFor="years">Years</label>
                <input type="number" id="years" value={props.years}
                    min="0" max="100"
                    onChange={(e) => props.dispatch(actions.setYears(e.target.value))} />
            </div>
            <div className="form-group">
